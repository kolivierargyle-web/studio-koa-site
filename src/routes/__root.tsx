  ...
  head: () => ({
    meta: [
      ...
      { title: "Koa Studio — Creative Direction & Production" },
      {
        name: "description",
        content:
          "Koa Studio is a full-service creative direction and production studio. Concept to final cut.",
      },
      { name: "author", content: "Koa Studio" },
      { property: "og:title", content: "Koa Studio — Creative Direction & Production" },
      {
        property: "og:description",
        content: "Concept to final cut. Photography, video and brand identity.",
      },
