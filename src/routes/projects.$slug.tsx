    ...
    return (
      <main className="w-full bg-white">
        ...
        <section className="w-full bg-white py-20">
          <div className={`grid ${isMobile ? 'grid-cols-1 px-5' : 'grid-cols-2'}`} style={{ gap: '50px', justifyContent: 'start' }}>
            {[shylaGrid1, shylaGrid2, shylaGrid3, shylaGrid4, shylaGrid5].map((src, idx) => (
              <img
                key={idx}
                src={src}
