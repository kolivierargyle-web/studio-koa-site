...
<nav className="w-full bg-black">
  <div className="flex items-center justify-between text-[24px] font-medium text-paper mx-auto" style={{ width: "1447px", height: "95px", paddingLeft: "40px", paddingRight: "40px", paddingTop: "1.56rem", paddingBottom: "1.56rem" }}>
