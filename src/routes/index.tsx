...
<section className="w-full bg-white">
  <nav className="flex items-center justify-center px-[20px] sm:px-[40px] relative">
    <div className="flex gap-[8px] sm:gap-[32px] absolute left-[20px] sm:left-[40px]">
      <a href="#about" onClick={(e) => handleNavClick(e, 'about')} className="text-[10px] sm:text-sm md:text-[1.62rem] text-black hover:text-[#BB95FF] cursor-pointer no-underline py-[30px]">About</a>
      <a href="#services" onClick={(e) => handleNavClick(e, 'services')} className="text-[10px] sm:text-sm md:text-[1.62rem] text-black hover:text-[#BB95FF] cursor-pointer no-underline py-[30px]">Services</a>
      <a href="#work" onClick={(e) => handleNavClick(e, 'work')} className="text-[10px] sm:text-sm md:text-[1.62rem] text-black hover:text-[#BB95FF] cursor-pointer no-underline py-[30px]">Work</a>
    </div>
    <div className="flex gap-[8px] sm:gap-[32px] absolute right-[20px] sm:right-[40px]">
      <a href="#spotlight" onClick={(e) => handleNavClick(e, 'spotlight')} className="text-[10px] sm:text-sm md:text-[1.62rem] text-black hover:text-[#BB95FF] cursor-pointer no-underline py-[30px]">Creative spotlight</a>
      <a href="#contact" onClick={(e) => handleNavClick(e, 'contact')} className="text-[10px] sm:text-sm md:text-[1.62rem] text-black hover:text-[#BB95FF] cursor-pointer no-underline py-[30px]">Contact</a>
    </div>
  </nav>
</section>
{/* Work grid */}
