  ...
  return (
    <main className="bg-paper">
      ...
      <nav className="w-full bg-ink">
        <div className="flex items-center justify-between text-paper uppercase" style={{ fontFamily: "Didact Gothic, sans-serif", fontSize: "24px", fontWeight: 400, paddingLeft: "33px", paddingRight: "33px", paddingTop: "2rem", paddingBottom: "2rem" }}>
      ...
      <footer id="contact" className="bg-ink text-paper">
        <div>
          <div className="flex items-center justify-between px-[40px] py-11">
